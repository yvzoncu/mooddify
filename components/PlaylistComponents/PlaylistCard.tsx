...
const PlaylistCard: React.FC<PlaylistCardProps> = ({
  ...
  return (
    <div
      className="w-full bg-black rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer group"
      onClick={handleClick}
    >
        ...
        <div className="flex items-center gap-3">
          ...
          {onDelete && (
            <button
              ...
              className="p-1.5 rounded-full bg-gray-600 transition-colors text-gray-400 hover:text-red-400 opacity-0 group-hover:opacity-100"
